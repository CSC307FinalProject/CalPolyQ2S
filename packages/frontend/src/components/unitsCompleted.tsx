...
const UnitsCard: React.FC<UnitCardProps> = ({ units, unit_type }) => {
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm w-64 text-left flex flex-col items-start"
...
export const Cards: React.FC<UnitAndTermCardProps> = ({ units, terms, unit_type }) => {
  return (
